...
/**
  ...
  - *multiline* If true then the hitting return will add to the value instead of exiting the inline editor.
  ...
  - *commitOnBlur* If true then bluring will commit the value, otherwise it will discard the current value.  Defaults to true.
