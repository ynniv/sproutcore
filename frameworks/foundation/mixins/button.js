...
SC.Button = {
  ...
  */
  ...
  /**
    The button title.  If localize is true, then this should be the localization key to display.  Otherwise, this will be the actual string displayed in the title.  This property is observable and bindable.
  ...
  */
  ...
  /**
    ...
    @param {Boolean} firstTime true if first time rendering
